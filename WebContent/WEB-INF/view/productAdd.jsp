	...
	<div class="user container"
		...
		<div class="user_center_body" style="padding: 8px; width: 100%;">
			...
			<section style="margin-top: 16px; width: 100%;" class="container">
				...
				<form class="form-horizontal" action="productAdd.htm" method="POST"
				 enctype="multipart/form-data">
					<h3 style="text-align: center;">新增产品</h3>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<span style="color: red">图片文件建议不要超过2M</span><br> <img src=""
								alt="" id="preview-img"
								style="display: none; margin-top: 8px; max-width: 200px;">
						</div>
					</div>
